...
public class ReporteLibroDiarioController {
	...
	@PostMapping("/DescargarReporteLibroDiario")
	public ResponseEntity<Resource> DescargarReporteLibroDiario(@RequestBody Map<String, Object> requestBody,HttpServletRequest request, Model model) 
       ...
       // Convertir List<String> a List<Integer>
		...
		for (TblLocales L : Local) {
			...
			params.put("P_fechaInicial", FechaInicial);
			params.put("p_fechaFinal", FechaFinal);
		...
		lista = tblDctoService.listaComprobantesLibroDiario(idLocal, xComprobantesIntList, FechaInicial, FechaFinal);
