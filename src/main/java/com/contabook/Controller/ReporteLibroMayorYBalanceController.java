...
@Controller
public class ReporteLibroMayorYBalanceController {
	...
	@GetMapping("/ReporteLibroMayorYBalance")
	public String reporteLibroMayorYBalance(HttpServletRequest request,Model model) {
		...
		//------------------------------------------------------------------------------------------------------------------------------------------
			...
			return "Reportes/Balances/ReporteLibroMayorYBalance";
	...
	@PostMapping("/DescargarLibroMayorYBalance")
	public ResponseEntity<Resource> DescargarLibroMayorYBalance(@RequestBody Map<String, Object> requestBody,HttpServletRequest request, Model model) 
