...
//		    List<TblDctoDTO> listaMovimientoPorAuxiliar(int idLocal, int idPeriodo, List<Integer> cuentasContables);
		 ...
		 @Query(value = "       SELECT DISTINCT tblDcto.idTipoCpte,                                 "                           
                 ...
                 + "       GROUP BY idLocal, idCpte, idTipoCpte, idCuentaAux, idtipoTercero    "          
                 + "        ) TmpDetalle                                                       "          
                 ...
                 + "       AND TmpDetalle.idCliente = tercero.CC_Nit COLLATE DATABASE_DEFAULT  " 
					+ "    AND TmpDetalle.idtipoTercero = tercero.idTipoTercero            "
					+ "    	WHERE tblDcto.idLocal = ?1                                            "                                     
					+ "    	AND tblDcto.idPeriodo BETWEEN  ?2 AND ?3                      "                    
					...
					+ "   		  ORDER BY idCliente desc                                         ",
	             nativeQuery = true)
		    List<TblDctoDTO> listaMovimientoPorAuxiliar(int idLocal, int idPeriodoDesde, int idPeriodoHasta, List<Integer> cuentasContables);
...
//		    List<TblDctoDTO> listaMovimientoPorTercero(int idLocal, int idPeriodo, String idCliente);
		 ...
		 @Query(value = "       SELECT DISTINCT tblDcto.idTipoCpte,                                 "                           
                 ...
                 + "       AND TmpDetalle.idCliente = tercero.CC_Nit COLLATE DATABASE_DEFAULT  " 
					...
					+ "   		  ORDER BY idCliente desc                                         ",
	             nativeQuery = true)
		    List<TblDctoDTO> listaMovimientoPorTercero(int idLocal, int idPeriodoDesde, int idPeriodoHasta, String idCliente);
		 ...
		 @Query(value = "        SELECT tmpMVT.idLocal,                                                                            "          
                 ...
                 + "     AND tblPucAux.idCuentaAux = tblDctoDetalle.idCuentaAux  									         "          
		            ...
		            + "   	 ON tblDctoDetalle.idLocal = tercero.idLocal                                                         "          
                 + "     AND tblDctoDetalle.idCliente = tercero.CC_Nit COLLATE DATABASE_DEFAULT                               " 
		            + " AND tblDctoDetalle.idtipoTercero = tercero.idTipoTercero                                               "
					+ "	 INNER JOIN tblTipoCpte                                                                                  "          
		    	    + "     ON tblDcto.idTipoCpte = tblTipoCpte.idTipoCpte                                                       "          
                 + "     WHERE tblDcto.idLocal=?1                                                                            "                     
                 + "     AND tblDcto.idPeriodo < ?2                                                                       "                     
                 + "     AND LEFT(CAST(tblDcto.idPeriodo AS VARCHAR), 4) = LEFT(202401, 4)                                    "                     
                 + "     AND tercero.CC_Nit = ?4                                                                      "          
                 ...
                 + "     ORDER BY 1,3                                                                                         ",
	             nativeQuery = true)
		    List<TblDctoDTO> repMovimientoAuxTercero(int idLocal, int idPeriodoDesde, int idPeriodoHasta, String idCliente);
...
//		     List<TblDctoDTO> listaMovimientoPorTerceroYAuxiiar(int idLocal, int idPeriodo, String idCliente, List<Integer> cuentasContables);
		 ...
		 @Query(value = "    SELECT DISTINCT tblDcto.idTipoCpte,                                      "                                
                 ...
                 + "   AND TmpDetalle.idCliente = tercero.CC_Nit COLLATE DATABASE_DEFAULT        " 
					...
					+ "		AND tblDcto.idPeriodo BETWEEN ?2 AND ?3                         "          
					+ "  	AND tercero.CC_Nit = ?4                                         "                          
					+ "  	AND TmpDetalle.idCuentaAux IN ?5                      "                                               
					+ "   	GROUP BY tblDcto.idTipoCpte,                                            "                                 
					+ "            tblDcto.idCpte,                                                  "                                    
					+ "            tblDcto.fechaDcto,                                               "                                  
					+ "            tblDcto.idPeriodo,                                               "                                  
					...
					+ "  		  ORDER BY idCliente desc                                           ",
	             nativeQuery = true)
		     List<TblDctoDTO> listaMovimientoPorTerceroYAuxiiar(int idLocal, int idPeriodoDesde, int idPeriodohasta, String idCliente, List<Integer> cuentasContables);
		 ...
		 @Query(value = "      SELECT tmpMVT.idLocal,                                                                          "          
                 ...
                 + "    AND LEFT(CAST(tblDcto.idPeriodo AS VARCHAR), 4) = LEFT(202401, 4)                                 "                        
                 + "    AND tercero.CC_Nit = ?4                                                                           "          
					+ "  AND tblDctoDetalle.idCuentaAux IN ?5                                                                "                  
                 + "    GROUP BY  tblDcto.idLocal,                                                                        "                        
                 + "              tblDcto.idPeriodo,                                                                      "                        
                 + "    		  tblDctoDetalle.idCuentaAux,                                                                "          
					+ " 		  tblDctoDetalle.idCpte,                                                                     "          
                 ...
                 + "    ORDER BY 1,3                                                                                      ",
	             nativeQuery = true)
		     List<TblDctoDTO> repMovimientoPorTerceroYAuxiiar(int idLocal, int idPeriodoDesde, int idPeriodoHasta, String idCliente, List<Integer> cuentasContables);
...
//			        + "     WHERE tblDcto.idLocal = ?1                                                                "                                           	    
//					+ "	  AND   tblDcto.idPeriodo BETWEEN ?2 AND ?3                                            "          
//					+ "	  AND tblDctoDetalle.idCuentaAux BETWEEN ?4 AND ?5                                 "                
//			        + "     GROUP BY tblDctoDetalle.idLocal,                                                           "                                          
//			        + "     tblDctoDetalle.idCuentaAux							                                       "                          
//			        + "     ) AS tmpTOT                                                                                "                                         
//			        + "     ON tmpTOT.idLocal  = tblPucAux.idLocal                                                     "                                        
...
//			        + "   ORDER BY 1,11,9,7,5,2                                                                        ",
//	             nativeQuery = true)
//		     List<TblDctoDTO> listaBalancePruebaGeneralIdPeriodoYAuxiiar(int idLocal, int idPeriodoDesde, int idPeriodoHasta, int idCuentaAux1, int idCuentaAux2);
		 
		 
		 
		 @Query(value = "     SELECT tmpMVT.idLocal,                                                                          "                                  		                            
					+ "	 		MAX(CONVERT(VARCHAR, tmpMVT.fechaDcto, 23) )AS fechaDcto,                                   "                                                                                                                                   
					+ "	 		tmpMVT.idCuentaAux,                                                                         "                               
	                + "           MAX(tmpPUC.nombreAuxiliar) AS nombreAuxiliar,                                             "                       
					+ "			( SELECT TOP 1 tblPuc.nombreCuenta                                                          "                                                                                
				    + "       FROM  tblPuc                                                                                  "                                                                              
				    + "        WHERE SUBSTRING(LTRIM(STR(tblPuc.idCuenta)),1,6)=                                            "                                                                               
				    + "        SUBSTRING(LTRIM(STR(tmpMVT.idCuentaAux)),1,6) ) AS nombreSubCuenta,                          "                                                                               
				    + "        SUBSTRING(LTRIM(STR(tmpMVT.idCuentaAux)),1,6) AS idSubCuenta,                                "                       
					+ "			( SELECT TOP 1 tblPuc.nombreCuenta                                                          "                                                                                
				    + "       FROM  tblPuc                                                                                  "                                                                              
				    + "        WHERE SUBSTRING(LTRIM(STR(tblPuc.idCuenta)),1,4)=                                            "                                                                               
				    + "        SUBSTRING(LTRIM(STR(tmpMVT.idCuentaAux)),1,4) ) AS nombreCuenta,                             "                                                                            
				    + "        SUBSTRING(LTRIM(STR(tmpMVT.idCuentaAux)),1,4) AS idCuenta,                                   "                                          
				    + "        (SELECT TOP 1 tblPuc.nombreCuenta                                                            "                                                                               
				    + "        FROM  tblPuc                                                                                 "                                                                               
				    + "       WHERE SUBSTRING(LTRIM(STR(tblPuc.idCuenta)),1,2)=                                             "                                                                              
				    + "        SUBSTRING(LTRIM(STR(tmpMVT.idCuentaAux)),1,2) ) AS nombreGrupo,                              "                                                                            
				    + "        SUBSTRING(LTRIM(STR(tmpMVT.idCuentaAux)),1,2) AS idGrupo,                                    "                                                                            
				    + "        (SELECT TOP 1 tblPuc.nombreCuenta                                                            "                                                                               
				    + "        FROM  tblPuc                                                                                 "                                                                               
				    + "       WHERE SUBSTRING(LTRIM(STR(tblPuc.idCuenta)),1,1)=                                             "                                                                              
				    + "        SUBSTRING(LTRIM(STR(tmpMVT.idCuentaAux)),1,1) ) AS nombreClase,                              "                                                                            
				    + "        SUBSTRING(LTRIM(STR(tmpMVT.idCuentaAux)),1,1) AS idClase,                                    "                                                                                                                  
					+ "	 		MAX(tmpMVT.nombreCmpte) AS tipoComprobante,                                                 "                             
					+ "	         MAX(tmpMVT.observacion) AS detalle,                                                        "                            
	                + "           SUM(tmpMVT.vrTotalDebitoAnterior) AS vrTotalDebitoAnterior,                               "                                             
	                + "    	   SUM(tmpMVT.vrTotalCreditoAnterior) AS vrTotalCreditoAnterior, 								"                              		   
	                + "    	   SUM(tmpMVT.vrTotalDebitoActual) AS vrTotalDebitoActual,                                      "                                          
	                + "    	   SUM(tmpMVT.vrTotalCreditoActual) AS vrTotalCreditoActual,   									"                              	   
		 ...
		 @Query(value = "     SELECT tmpMVT.idLocal,                                                                          "                                  		                            
	                ...
	                + "    ORDER BY 1, 3                                                                                    ",
	             nativeQuery = true)
		     List<TblDctoDTO> listaBalancePruebaGeneralTodasCuentasIdPeriodoYAuxiiar(int idLocal, int idPeriodoDesde, int idPeriodoHasta, int idCuentaAux1, int idCuentaAux2);
		 
//		 @Query(value = "      SELECT  tblPucAux.idLocal                                                                      "             
//					+ "      ,tmpTOT.CC_Nit                                                                                 "          
//					+ "      ,UPPER(tmpTOT.nombreTercero) AS nombreTercero                                                  "          
//				    + "     ,tblPucAux.idCuentaAux                                                                          "                                                                 
//				    + "     ,tblPucAux.nombreCuenta AS nombreAuxiliar                                                       "                                                                  
//				    + "     ,tblPuc.nombreCuenta AS nombreSubCuenta                                                         "                                                                  
//				    + "     ,tblPuc.idCuenta AS  idSubCuenta                                                                "                                 
...
//				    + "     ORDER BY 1,11,9,7,5,2                                                                           ",
//	             nativeQuery = true)
//		     List<TblDctoDTO> listaBalancePruebaPorTercero(int idLocal, int idPeriodoDesde, int idPeriodoHasta, int idCuentaAux1, int idCuentaAux2);
		 ...
		 @Query(value = "       SELECT tmpMVT.idLocal,                                                                           "                      		                            
				    ...
				    + "        SUBSTRING(LTRIM(STR(tmpMVT.idCuentaAux)),1,1) ) AS nombreClase,                                 "                                                               
				    + "        SUBSTRING(LTRIM(STR(tmpMVT.idCuentaAux)),1,1) AS idClase,                                       "          
					+ "	 		MAX(tmpMVT.nombreTercero) AS nombreTercero,                                                    "                                        
					+ "	 		MAX(tmpMVT.nombreCmpte) AS tipoComprobante,                                                    "                
					+ "	         MAX(tmpMVT.observacion) AS detalle,                                                           "               
	                + "           SUM(tmpMVT.vrTotalDebitoAnterior) AS vrTotalDebitoAnterior,                                  "                                
	                + "    	   SUM(tmpMVT.vrTotalCreditoAnterior) AS vrTotalCreditoAnterior, 								   "                 		   
					...
					+ "	 		  tblDctoDetalle.idCpte,                                                                       "                  
					+ "	 		  tblDctoDetalle.idTipoCpte,                                                                   "                  
					+ "	 		  MAX (tercero.CC_Nit) AS idCliente,                                                        "                  
					+ "	 		  MAX (tercero.nombreTercero) AS nombreTercero,                                                "                  
					+ "	 		  tblTipoCpte.nombreCmpte,                                                                     "          
					+ "	           tblDctoDetalle.observacion                                                                  "          
	                + "    FROM      tblDcto                                                                                   "                                
		 ...
		 @Query(value = "       SELECT tmpMVT.idLocal,                                                                           "                      		                            
	                ...
	                + "    AND tblDcto.idPeriodo < ?2                                                                      "                                    
	                + "    AND LEFT(CAST(tblDcto.idPeriodo AS VARCHAR), 4) = LEFT(202401, 4)                                   "
	                + "   AND tercero.idTipoTercero IN (2,3)                                                                   "
	                + "    GROUP BY  tblDcto.idLocal,                                                                          "                                
	                + "              tblDcto.idPeriodo,                                                                        "                                
	                + "    		  tblDctoDetalle.idCuentaAux,                                                                  "                  
					+ "	 		  tblDctoDetalle.idCpte,                                                                       "                  
	                ...
	                + "    ORDER BY 1, 4                                                                                       ",
	             nativeQuery = true)
		     List<TblDctoDTO> listaBalancePruebaPorTerceroSoloPeriodo(int idLocal, int idPeriodoDesde, int idPeriodoHasta);
		 ...
		 @Query(value = "   SELECT tmpMVT.idLocal,                                                                                "              
	                ...
	                + "   ORDER BY 1, 6                                                                                         ",
	             nativeQuery = true)
		     List<TblDctoDTOSubReport> listaBalancePruebaPorTerceroSubReport(int idLocal, int idPeriodoDesde, int idPeriodoHasta,  List<Integer> cuentasContables);
...
//		     List<TblDctoDTO> listaBalancePruebaGeneralPorIdPeriodo(int idLocal, int idPeriodo);
		...
		/* @Query(value = "          SELECT  tblPucAux.idLocal                                                                "                                                                                                                                             
		 ...
		 @Query(value = "     SELECT tmpMVT.idLocal,                                                                          "                                  		                            
	                ...
	                + "    ORDER BY 1, 3                                                                                    ",
	          nativeQuery = true)
		     List<TblDctoDTO> listaBalancePruebaGeneralPorIdPeriodo( int idLocal, int idPeriodoDesde, int idPeriodoHasta);
		 ...
		 @Query(value = "     SELECT tmpMVT.idLocal,                                                                          "                                  		                            
	                ...
	                + "    ORDER BY 1, 3                                                                                    ",
	          nativeQuery = true)
		     List<TblDctoDTO> listaBalancePruebaGeneralTodasCuentasPorIdPeriodo( int idLocal, int idPeriodoDesde, int idPeriodoHasta);
		 ...
		 @Query(value = "   SELECT tmpMVT.idLocal,                                                                           "                         
                 ...
                 + "   ORDER BY 1,3                                                                                     ",
	             nativeQuery = true)
		     List<TblDctoDTO> listaLibroMayorYBalance(int idLocal, int idPeriodoDesde, int idPeriodohasta,  List<Integer> tipoComprobante);
